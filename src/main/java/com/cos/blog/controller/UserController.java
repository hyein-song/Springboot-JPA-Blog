...
public class UserController {
   ...
   @GetMapping("/auth/joinForm")
    ...
    public String kakaoCallback(String code){
        ...
        // Retrofit2, OkHttp, RestTemplate 등의 라이브러리를 사용함
        ...
        // body data와 header를 가지고 있는 엔티티가 됨
        // HttpHeader와 HttpBody를 하나의 오브젝트에 담기 (exchange함수가 HttpEntity를 파라미터로 받기 때문에)
